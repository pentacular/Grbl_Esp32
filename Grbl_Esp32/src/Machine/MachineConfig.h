...
namespace Machine {
    ...
    public:
        ...
        Setting<bool>  _laserMode          = false;
        Setting<float> _arcTolerance       = 0.002f;
        Setting<float> _junctionDeviation  = 0.01f;
        Setting<bool>  _verboseErrors      = false;
        Setting<bool>  _reportInches       = false;
        Setting<bool>  _homingInitLock     = true;
        Setting<int>   _softwareDebounceMs = 0;
        ...
        Setting<bool> _enableParkingOverrideControl = false;
        Setting<bool> _deactivateParkingUponInit    = false;
        ...
        Setting<bool> _checkLimitsAtInit = true;
        ...
        Setting<bool> _limitsTwoSwitchesOnAxis = false;

        // This option will automatically disable the laser during a feed hold by invoking a spindle stop
        // override immediately after coming to a stop. However, this also means that the laser still may
        // be reenabled by disabling the spindle stop override, if needed. This is purely a safety feature
        // to ensure the laser doesn't inadvertently remain powered while at a stop and cause a fire.
        Setting<bool> _disableLaserDuringHold = true;

        // Allows GRBL to track and report gcode line numbers. Disabled by default.
        Setting<bool> _useLineNumbers = false;

        Setting<String> _board = "None";
        Setting<String> _name  = "None";
